...
public class ReligionView extends ReligionMasterWrapperView  {
	...
	interface GxtUiBinder extends UiBinder<Widget, ReligionView> {
	}
	...
	protected PersistingCallback persitingCallback = new PersistingCallback() {
        ...
        @UiField
        NumberField<Integer> religionId;
	...
	public Widget asWidget() {
        ...
        description.addValidator(new MaxLengthValidator(60));

        classification.addValidator(new MaxLengthValidator(20));

		this.finalizeForm(callback, ENTITY_NAME);
		this.driver = GWT.create(ReligionDriver.class);
		this.edit();
		return widget;
	}
	...
	*/
	...
	interface ReligionDriver extends
			SimpleBeanEditorDriver<Religion, ReligionView> {
	}
	...
	*/
	@Override
	protected SimpleBeanEditorDriver<Religion, ? super ViewFormBase<Religion>> createDriver() {
		return GWT.create(ReligionDriver.class);
	}
