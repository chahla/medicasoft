...
public class ProfessionView extends ProfessionMasterWrapperView  {
	...
	interface GxtUiBinder extends UiBinder<Widget, ProfessionView> {
	}
	...
	protected PersistingCallback persitingCallback = new PersistingCallback() {
        ...
        @UiField
        NumberField<Integer> professionId;
...
@UiField
	...
	public Widget asWidget() {
        ...
        classification.addValidator(new MaxLengthValidator(50));

		this.finalizeForm(callback, ENTITY_NAME);
		this.driver = GWT.create(ProfessionDriver.class);
		this.edit();
		return widget;
	}
	...
	*/
	...
	interface ProfessionDriver extends
			SimpleBeanEditorDriver<Profession, ProfessionView> {
	}
	...
	*/
	@Override
	protected SimpleBeanEditorDriver<Profession, ? super ViewFormBase<Profession>> createDriver() {
		return GWT.create(ProfessionDriver.class);
	}
